...
const STEPS = [
  {
    ...
    body: 'Anchor never generates story prose. It reads what you write, compares it with your confirmed story bible, and asks whether the new work still feels true to your characters. You stay in control.',
    icon: 'A',
    iconFont: true,
    cta: 'Show me how',
  },
  ...
  },
  {
    ...
    body: 'The X-Ray panel on the right surfaces characters on the current page — their goals, fears, and voice patterns — without leaving the editor. Story-integrity scans run only when you choose Scan Scene or Scan Draft.',
    icon: '✦',
    cta: 'Next',
  },
  {
    ...
    body: 'Highlight any text in the editor, right-click, and choose Pressure Test. Anchor compares the passage with the character bible, cites the passage, and returns a pass, question, or possible concern. It never rewrites.',
    icon: '⚡',
    cta: 'Next',
  },
  {
    id: 'living_bible',
    title: 'Living Bible',
    subtitle: 'You decide when Anchor reads.',
    body: 'Choose Scan Scene or Scan Draft when you want a story-integrity check. If Anchor notices a possible character question or relationship shift, it shows the evidence and reasoning. You decide whether to confirm or dismiss it. Nothing changes without your approval.',
    icon: '◉',
    cta: 'Start writing',
  },
]
